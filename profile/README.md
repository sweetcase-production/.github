...
|프로젝트명|설명|기술스택|
|---|---|---|
|traildata|등산을 포함한 하이킹 루트 데이터를 분석 및 조회하는 API로 trailine 프로젝트의 핵심 요소 입니다.|kafka, postgresql, python|
|trailine|django 기반의 등산 및 트레킹 정보를 조회하고 직접 정보에 기여할 수 있는 웹, 앱 서비스|DRF, MySQL, JQuery or React (in Web)|
